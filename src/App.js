  ...
  return (
    <>
      <body>
        <div id='headContent'>
          <ul id="navBar">
            <li id="profileName"><h1>Vanessa Martin Del Campo</h1></li>
            <li id="home" className='navButton'><a href="https://www.google.com">Home</a></li>
            <li id="contact" className='navButton'><a href="google.com">Contact</a></li>
            <li id="info" className='navButton'><a href='#info'>Info</a></li>
          </ul>


          <CircleProfilePhoto />
          <h2 id='introQuote'>Boost Your Success with Data-Driven Marketing Strategies</h2>
          {/** Another Example: Turning Ideas into Impact*/}
        </div>
        ...
        <div id='bodyContent'>
          <div className='container'>
            <div id='summarySection'>
              ...
              <div id='summary'><p>I'm an online marketing manager, specialized in social media and content marketing. I make data-based decisions for the best performance but I'm also not afraind to let my creativity shine.</p>
